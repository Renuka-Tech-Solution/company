...
const initClipboard = () => {
  ...
  (void 0).querySelectorAll(".code-wrapper-inner").forEach(function(element) {
    if (!element.previousElementSibling || !element.previousElementSibling.classList.contains("btn-clipboard")) {
...
const initPlayer = () => {
  Array.from((void 0).querySelectorAll(".player")).map(
    (element) => {
...
const injectSvg = async () => {
  ...
  SVGInject((void 0).getElementsByClassName("icon-svg"));
};
const _sfc_main = {
  __name: "default",
...
//# sourceMappingURL=default-tOqwmXXR.mjs.map
