...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"tagPosition":"bodyClose","src":"/assets/js/custom.js"}],"noscript":[]};
