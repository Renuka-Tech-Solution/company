    ...
    <div class="widget">
      ...
      <nav class="ps-xl-5" id="sidebar-nav">
        <ul class="list-unstyled fs-sm lh-sm text-reset scrollspyLinks">
          <li>
            <a class="nav-link scroll active" href="#snippet-1"
              >Simple Carousel</a
            >
          </li>
          <li>
            <a class="nav-link scroll" href="#snippet-2">Card Carousel</a>
          </li>
          <li><a class="nav-link scroll" href="#snippet-3">Text Slider</a></li>
          <li><a class="nav-link scroll" href="#snippet-4">Image Slider</a></li>
          <li>
            <a class="nav-link scroll" href="#snippet-5">Thumbnail Slider</a>
          </li>
          <li>
            <a class="nav-link scroll" href="#instructions">Instructions</a>
          </li>
        </ul>
      </nav>
      <!-- /nav -->
