    ...
    <section id="snippet-1" class="wrapper pt-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="mb-2"></div>
          <span class="badge bg-pale-yellow text-yellow rounded-pill"
            >Badge</span
          >
          <span class="badge bg-pale-orange text-orange rounded-pill"
            >Badge</span
          >
          ...
          <span class="badge bg-pale-violet text-violet rounded-pill"
            >Badge</span
          >
          <span class="badge bg-pale-purple text-purple rounded-pill"
            >Badge</span
          >
          ...
          <span class="badge bg-pale-fuchsia text-fuchsia rounded-pill"
            >Badge</span
          >
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;badge bg-primary rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge bg-yellow rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge bg-orange rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge bg-red rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge bg-pink rounded-pill&quot;&gt;Badge&lt;/span&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;badge gradient-1 rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge gradient-2 rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge gradient-3 rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge gradient-4 rounded-pill&quot;&gt;Badge&lt;/span&gt;
&lt;span class=&quot;badge gradient-5 rounded-pill&quot;&gt;Badge&lt;/span&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;badge bg-primary rounded-0&quot;&gt;Square&lt;/span&gt;
&lt;span class=&quot;badge bg-primary rounded&quot;&gt;Rounded&lt;/span&gt;
    ...
    <section id="snippet-4" class="wrapper py-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <span class="badge badge-lg bg-primary rounded-pill">Large</span>
        </div>
        <!--/.card-body -->
        <div class="card-footer position-relative">
          <a
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;badge bg-primary rounded-pill&quot;&gt;Default&lt;/span&gt;
&lt;span class=&quot;badge badge-lg bg-primary rounded-pill&quot;&gt;Large&lt;/span&gt;</code></pre>
            </div>
            <!--/.code-wrapper-inner -->
          </div>
          <!--/.code-wrapper -->
