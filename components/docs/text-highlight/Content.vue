    ...
    <section id="snippet-1" class="wrapper pt-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          <p class="lead mb-0">
            Build and manage an
            <span class="underline">impressive</span> website with Sandbox in no
            time.
          </p>
        </div>
        <!--/.card-body -->
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;underline&quot;&gt;text&lt;/span&gt;
...
&lt;span class=&quot;underline ash&quot;&gt;text&lt;/span&gt;</code></pre>
    ...
    <section id="snippet-2" class="wrapper pt-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          <h2 class="display-3 lh-xs mb-4">
            Build and manage an
            <span class="underline-2 yellow">impressive</span> website with
            Sandbox in no time.
          </h2>
          <h2 class="display-3 lh-xs mb-0">
            Build and manage an
            <span class="underline-2 underline-gradient-2">impressive</span>
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;underline-2 yellow&quot;&gt;text&lt;/span&gt;
    ...
    <section id="snippet-3" class="wrapper pt-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          <h2 class="display-3 lh-xs mb-4">
            Build and manage an
            <span class="underline-3 style-1 red">impressive</span> website with
            Sandbox in no time.
          </h2>
          <h2 class="display-3 lh-xs mb-4">
            Build and manage an
            <span class="underline-3 style-2 yellow">impressive</span> website
            with Sandbox in no time.
          </h2>
          <h2 class="display-3 lh-xs mb-4">
            Build and manage an
            <span class="underline-3 style-3 green">impressive</span> website
            with Sandbox in no time.
          </h2>
        </div>
        <!--/.card-body -->
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;underline-3 style-1 yellow&quot;&gt;text&lt;/span&gt;
