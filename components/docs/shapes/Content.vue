        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;shape bg-dot yellow w-18 h-18&quot;&gt;&lt;/div&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;shape bg-line yellow w-18 h-18&quot;&gt;&lt;/div&gt;
...
&lt;div class=&quot;shape bg-line ash rounded-circle w-18 h-18&quot;&gt;&lt;/div&gt;</code></pre>
    ...
    <section id="snippet-3" class="wrapper pt-16 scrollSpysection">
      ...
      <p class="lead mb-8">
        All background color options (<nuxt-link
          to="/docs/elements/background#snippet-3"
          class="internal"
          >solid</nuxt-link
        >,
        <nuxt-link to="/docs/elements/background#snippet-4" class="internal"
          >soft</nuxt-link
        >,
        <nuxt-link to="/docs/elements/background#snippet-5" class="internal"
          >pale</nuxt-link
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;shape bg-soft-yellow w-18 h-18&quot;&gt;&lt;/div&gt;
...
&lt;div class=&quot;shape bg-soft-ash rounded-circle w-18 h-18&quot;&gt;&lt;/div&gt;</code></pre>
    ...
    <section id="snippet-4" class="wrapper pt-16 scrollSpysection">
      ...
      <p class="lead mb-8">
        <code class="code">primary</code>, <code class="code">aqua</code>,
        <code class="code">green</code>, <code class="code">leaf</code>,
        <code class="code">navy</code>, <code class="code">orange</code>,
        <code class="code">pink</code>, <code class="code">purple</code>,
        <code class="code">red</code>, <code class="code">violet</code>,
        <code class="code">yellow</code>, <code class="code">fuchsia</code>,
        <code class="code">sky</code>, <code class="code">grape</code>,
        <code class="code">pale-primary</code>,
        <code class="code">pale-aqua</code>,
        <code class="code">pale-green</code>,
        <code class="code">pale-leaf</code>,
        <code class="code">pale-navy</code>,
        <code class="code">pale-orange</code>,
        <code class="code">pale-pink</code>,
        <code class="code">pale-purple</code>,
        <code class="code">pale-red</code>,
        <code class="code">pale-violet</code>,
        <code class="code">pale-yellow</code>,
        <code class="code">pale-fuchsia</code>,
        <code class="code">pale-sky</code>,
        <code class="code">pale-grape</code>,
        <code class="code">soft-primary</code>,
        <code class="code">soft-aqua</code>,
        <code class="code">soft-green</code>,
        <code class="code">soft-leaf</code>,
        <code class="code">soft-navy</code>,
        <code class="code">soft-orange</code>,
        <code class="code">soft-pink</code>,
        <code class="code">soft-purple</code>,
        <code class="code">soft-red</code>,
        <code class="code">soft-violet</code>,
        <code class="code">soft-yellow</code>,
        <code class="code">soft-fuchsia</code>,
        <code class="code">soft-sky</code>,
        <code class="code">soft-grape</code>.
      </p>
      <div class="card">
        <div class="card-body">
          <div class="row g-6">
            <div class="col-lg-3">
              <div class="shape green w-18 h-18">
                <nuxt-img
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape pale-green w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/hex.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape soft-green w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/hex.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape pale-primary w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/tri.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape soft-primary w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/tri.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape pale-red w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/circle.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape soft-red w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/circle.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape yellow w-18 h-18">
                <nuxt-img
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape pale-yellow w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/scribble.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape soft-yellow w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/scribble.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape purple w-18 h-18">
                <nuxt-img
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape pale-purple w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/pie.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
            ...
            <!-- /column -->
            <div class="col-lg-3">
              <div class="shape soft-purple w-18 h-18">
                <nuxt-img
                  src="/assets/img/svg/pie.svg"
                  class="icon-svg w-100 h-100"
                  alt="photo"
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;shape primary w-18 h-18&quot;&gt;
  &lt;nuxt-img src=&quot;/assets/img/svg/hex.svg&quot; class=&quot; icon-svg w-100 h-100&quot; alt=&quot;&quot; /&gt;
&lt;/div&gt;

&lt;div class=&quot;shape primary w-18 h-18&quot;&gt;
  &lt;nuxt-img src=&quot;/assets/img/svg/tri.svg&quot; class=&quot; icon-svg w-100 h-100&quot; alt=&quot;&quot; /&gt;
&lt;/div&gt;

&lt;div class=&quot;shape primary w-18 h-18&quot;&gt;
  &lt;nuxt-img src=&quot;/assets/img/svg/circle.svg&quot; class=&quot; icon-svg w-100 h-100&quot; alt=&quot;&quot; /&gt;
&lt;/div&gt;
</code></pre>
            </div>
            <!--/.code-wrapper-inner -->
    ...
    <section id="snippet-5" class="wrapper py-16 scrollSpysection">
      <h2 class="mb-5">Doodles</h2>
      <div class="card">
        <div class="card-body">
          <div class="row gy-10">
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle1.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle2.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle3.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle4.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle5.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle7.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle8.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img src="/assets/img/svg/doodle9.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
            <div class="col-lg-4">
              <nuxt-img
            ...
            <!-- /column -->
            <div class="col-lg-12">
              <nuxt-img src="/assets/img/svg/doodle6.svg" class="h-14" alt="photo" />
            </div>
            <!-- /column -->
          </div>
          <!-- /.row -->
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;nuxt-img src=&quot;/assets/img/svg/doodle1.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle2.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle3.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle4.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle5.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle7.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle8.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle9.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle10.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle11.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;
&lt;nuxt-img src=&quot;/assets/img/svg/doodle6.svg&quot; class=&quot;h-14&quot; alt=&quot;&quot;&gt;</code></pre>
            </div>
            <!--/.code-wrapper-inner -->
          </div>
          <!--/.code-wrapper -->
