          ...
          <div class="tab-content mt-0 mt-md-5">
            <div class="tab-pane fade show active" id="tab3-1">
              <p>
                ...
                fermentum massa justo sit amet risus. Vestibulum id ligula porta
                felis euismod semper. Lorem ipsum dolor sit amet, consectetur
                adipiscing elit.
              </p>
              <p>
                Donec sed odio dui. Donec sed odio dui. Praesent commodo cursus
              ...
              <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                ...
                <li>
                  <i class="uil uil-check"></i>Donec id elit non mi porta
                  gravida at eget.
                </li>
                <li>
            ...
            <div class="tab-pane fade" id="tab3-2">
              <p>
                ...
                faucibus mollis interdum. Maecenas faucibus mollis interdum. Sed
              ...
              <p class="mb-0">
                ...
                nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus
            ...
            <div class="tab-pane fade" id="tab3-3">
              <p>
                ...
                tellus ac cursus commodo, tortor mauris condimentum nibh, ut
                fermentum massa justo sit amet risus. Cras mattis consectetur
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;ul class=&quot;nav nav-tabs nav-tabs-basic&quot;&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;ul class=&quot;nav nav-tabs nav-pills&quot;&gt;
  &lt;li class=&quot;nav-item&quot;&gt; 
    &lt;a class=&quot;nav-link active&quot; data-bs-toggle=&quot;tab&quot; href=&quot;#tab1-1&quot;&gt;
      &lt;i class=&quot;uil uil-phone-volume pe-1&quot;&gt;&lt;/i&gt;
      &lt;span&gt;Tab 1&lt;/span&gt;
...
&lt;!-- /.tab-content --&gt;</code></pre>
    ...
    <section id="snippet-3" class="wrapper py-16 scrollSpysection">
      ...
      <p class="lead mb-8">
        ...
        <nuxt-link to="/demo9" class="external" target="_blank"
          >Demo 9</nuxt-link
        >.
      </p>
      <div class="card">
        <div class="card-body">
          ...
          >
            <li class="nav-item">
              <a
                class="nav-link d-flex flex-row active"
                data-bs-toggle="tab"
                href="#tab2-1"
              >
                <div>
                  <nuxt-img
                    ...
                    class="icon-svg icon-svg-md text-yellow me-4"
                    alt="photo"
                  />
                </div>
                <div>
              ...
              >
                <div>
                  <nuxt-img
                    ...
                    class="icon-svg icon-svg-md text-green me-4"
                    alt="photo"
                  />
                </div>
                <div>
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;ul class=&quot;nav nav-tabs nav-tabs-bg nav-tabs-shadow-lg d-flex justify-content-between nav-justified flex-lg-row flex-column&quot;&gt;
  &lt;li class=&quot;nav-item&quot;&gt; 
    &lt;a class=&quot;nav-link d-flex flex-row active&quot; data-bs-toggle=&quot;tab&quot; href=&quot;#tab2-1&quot;&gt;
      &lt;div&gt;&lt;nuxt-img src=&quot;/assets/img/icons/lineal/rocket.svg&quot; class=&quot; icon-svg icon-svg-md text-yellow me-4&quot; alt=&quot;&quot; /&gt;&lt;/div&gt;
      &lt;div&gt;
  ...
  &lt;li class=&quot;nav-item&quot;&gt; 
    &lt;a class=&quot;nav-link d-flex flex-row&quot; data-bs-toggle=&quot;tab&quot; href=&quot;#tab2-2&quot;&gt;
      &lt;div&gt;&lt;nuxt-img src=&quot;/assets/img/icons/lineal/savings.svg&quot; class=&quot; icon-svg icon-svg-md text-green me-4&quot; alt=&quot;&quot; /&gt;&lt;/div&gt;
      &lt;div&gt;
