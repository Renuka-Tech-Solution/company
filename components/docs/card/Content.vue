        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;card&quot;&gt;&lt;div class=&quot;card-body&quot;&gt;...&lt;/div&gt;&lt;/div&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;card shadow-none bg-primary text-white&quot;&gt;&lt;div class=&quot;card-body&quot;&gt;...&lt;/div&gt;&lt;/div&gt;
...
&lt;div class=&quot;card shadow-none bg-soft-ash&quot;&gt;&lt;div class=&quot;card-body&quot;&gt;...&lt;/div&gt;&lt;/div&gt;</code></pre>
    ...
    <section id="snippet-3" class="wrapper pt-16 scrollSpysection">
      ...
      <p class="lead mb-8">
        <code class="code">border-primary</code>,
        <code class="code">border-aqua</code>,
        <code class="code">border-green</code>,
        <code class="code">border-leaf</code>,
        <code class="code">border-navy</code>,
        <code class="code">border-orange</code>,
        <code class="code">border-pink</code>,
        <code class="code">border-purple</code>,
        <code class="code">border-red</code>,
        <code class="code">border-violet</code>,
        <code class="code">border-yellow</code>,
        <code class="code">border-fuchsia</code>,
        <code class="code">border-sky</code>,
        <code class="code">border-grape</code>,
        <code class="code">border-soft-primary</code>,
        <code class="code">border-soft-aqua</code>,
        <code class="code">border-soft-green</code>,
        <code class="code">border-soft-leaf</code>,
        <code class="code">border-soft-navy</code>,
        <code class="code">border-soft-orange</code>,
        <code class="code">border-soft-pink</code>,
        <code class="code">border-soft-purple</code>,
        <code class="code">border-soft-red</code>,
        <code class="code">border-soft-violet</code>,
        <code class="code">border-soft-yellow</code>,
        <code class="code">border-soft-fuchsia</code>,
        <code class="code">border-soft-sky</code>,
        <code class="code">border-soft-grape</code>.
      </p>
      <div class="card">
        <div class="card-body">
          <div class="row g-6">
            ...
            <div class="col-lg-6">
              <div
                class="card bg-soft-yellow card-border-bottom border-soft-yellow"
              >
                <div class="card-body">
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;card card-border-start border-primary&quot;&gt;
          ...
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;div class=&quot;card&quot;&gt;
  &lt;nuxt-img class=&quot;card-img-top&quot; src=&quot;...&quot; alt=&quot;&quot; /&gt;
  &lt;div class=&quot;card-body&quot;&gt;
    ...
  &lt;/div&gt;
  &lt;!--/.card-body --&gt;
...
&lt;div class=&quot;card&quot;&gt;
  ...
  &lt;/div&gt;
  &lt;!--/.card-body --&gt;
  &lt;nuxt-img class=&quot;card-img-bottom&quot; src=&quot;...&quot; alt=&quot;&quot; /&gt;
&lt;/div&gt;
&lt;!--/.card --&gt;</code></pre>
            </div>
            <!--/.code-wrapper-inner -->
