    ...
    <div class="widget">
      ...
      <nav class="ps-xl-5" id="sidebar-nav">
        <ul class="list-unstyled fs-sm lh-sm text-reset scrollspyLinks">
          <li>
            <a class="nav-link scroll active" href="#snippet-1">Default</a>
          </li>
          <li><a class="nav-link scroll" href="#snippet-2">Alternative</a></li>
          <li><a class="nav-link scroll" href="#snippet-3">Breadcrumb</a></li>
        </ul>
      </nav>
      <!-- /nav -->
    </div>
