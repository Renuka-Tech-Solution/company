<template>
  <div class="col-xl-8 order-xl-2" data-bs-root-margin="-50px">
    <section class="wrapper pt-16 mb-n12">
      <div class="alert alert-primary alert-icon" role="alert">
        <i class="uil uil-exclamation-circle" style="margin-top: 4px"></i> You
        can apply any Sandbox color you see
        <nuxt-link
          to="/docs/styleguide/colors#snippet-4"
          class="internal bg-primary text-white"
          >here</nuxt-link
        >
        to your text.
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row gy-6">
            ...
            <!--/column -->
            <div class="col-md-6">
              <h2 class="fs-15 text-uppercase text-line text-navy mb-0">
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;h2 class=&quot;fs-15 text-uppercase text-navy&quot;&gt;Tiny heading&lt;/h2&gt;
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;ul class=&quot;unordered-list bullet-primary&quot;&gt;
  &lt;li&gt;List item.&lt;/li&gt;
  &lt;li&gt;List item.&lt;/li&gt;
  &lt;li&gt;List item.&lt;/li&gt;
  &lt;li&gt;List item.&lt;/li&gt;
              ...
              <figure>
                <blockquote class="fs-lg">
                  <p>
                    ...
                    commodo luctus, nisi erat porttitor ligula lacinia odio.
                  </p>
                </blockquote>
...
&lt;!-- /.card --&gt;</code></pre>
    ...
    <section id="snippet-7" class="wrapper pt-16 scrollSpysection">
      ...
      <div class="card">
        <div class="card-body">
          <div class="row gx-lg-8 gx-xl-12">
            <div class="col-md-4">
              <p>
                <span class="dropcap text-dark">A</span>enean non lectus sit
                amet est imperdiet cursus elementum vitae eros. Cras quis odio
                in risus euismod suscipit. Fusce viverra ligula vel justo
            ...
            <div class="col-md-4">
              <p>
                <span class="dropcap text-primary">A</span>enean non lectus sit
                amet est imperdiet cursus elementum vitae eros. Cras quis odio
                in risus euismod suscipit. Fusce viverra ligula vel justo
                bibendum semper amet.
              </p>
            ...
            <div class="col-md-4">
              <p>
                <span
                  class="dropcap rounded-circle text-primary bg-pale-primary"
                  >A</span
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;span class=&quot;dropcap text-dark&quot;&gt;A&lt;/span&gt;
...
&lt;span class=&quot;dropcap rounded-circle text-primary bg-pale-primary&quot;&gt;A&lt;/span&gt;</code></pre>
    ...
    <section id="snippet-8" class="wrapper py-16 scrollSpysection">
      <h2 class="mb-3">Links</h2>
      <p class="lead">Available options:</p>
      <p class="lead mb-8">
        <code class="code">link-body</code>,
        <code class="code">link-aqua</code>,
        <code class="code">link-green</code>,
        <code class="code">link-leaf</code>,
        <code class="code">link-navy</code>,
        <code class="code">link-orange</code>,
        <code class="code">link-pink</code>,
        <code class="code">link-purple</code>,
        <code class="code">link-red</code>,
        <code class="code">link-violet</code>,
        <code class="code">link-yellow</code>,
        <code class="code">link-fuchsia</code>,
        <code class="code">link-sky</code>,
        <code class="code">link-grape</code>.
      </p>
      <div class="card">
        <div class="card-body">
        ...
        >
          <div class="code-wrapper">
            <div class="code-wrapper-inner">
              <pre
                class="language-html"
              ><code>&lt;a href=&quot;#&quot; class=&quot;hover link-body&quot;&gt;Link example&lt;/a&gt;
