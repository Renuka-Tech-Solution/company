<template>
  <div class="row gy-6 mb-15 mb-md-17">
    <div class="col-lg-4">
      <h2 class="fs-16 text-uppercase text-primary mt-lg-18 mb-3">
        Our Pricing
      </h2>
      ...
      <nuxt-link to="/pricing" class="btn btn-primary rounded mt-2"
    ...
    <div class="col-lg-7 offset-lg-1 pricing-wrapper">
      ...
      <div class="row gy-6 mt-5">
        ...
        >
          <div
            class="pricing card shadow-lg card-border-top border-soft-primary"
          >
