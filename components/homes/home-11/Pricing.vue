<template>
  <section class="wrapper bg-gray">
    <div class="container py-14 pt-md-0 pb-md-17">
      <div class="row mt-md-n18 text-white text-center">
        <div class="col-lg-10 col-xl-9 mt-22 col-xxl-8 mx-auto text-center">
      ...
      <div class="row">
        <div class="col-xl-11 mx-auto">
          <div class="pricing-wrapper position-relative">
            ...
            ></div>
            <div
              class="shape rounded-circle bg-line primary rellax w-18 h-18 d-none d-lg-block"
              data-rellax-speed="1"
