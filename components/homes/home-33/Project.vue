        ...
        <div class="card-body p-12 pb-0">
          <div class="row">
            <div class="col-lg-4 pb-12 align-self-center">
              ...
              <nuxt-link
                to="/single-project"
                :class="`btn btn-sm ${card.btnClass} btn-icon btn-icon-end mb-0`"
                >See Project <i class="uil uil-arrow-up-right"></i
              ></nuxt-link>
            </div>
        ...
        <div v-for="(project, index) in projects" :key="index" class="col-lg-6">
          <div :class="project.cardClass">
            <div class="card-body p-12 pb-0">
              ...
              <nuxt-link
                to="/single-project"
                :class="`btn btn-sm ${project.btnClass} btn-icon btn-icon-end mb-8`"
                >See Project <i class="uil uil-arrow-up-right"></i
              ></nuxt-link>
            </div>
            <!--/.card-body -->
