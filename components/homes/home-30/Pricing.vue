<template>
  <div class="row gy-6">
    <div class="col-lg-4">
      ...
      <p class="lead fs-lg mb-3">
        We offer great prices, premium and quality products for your business.
      </p>
      <p>
        Enjoy a <a href="#" class="hover">free 30-day trial</a> and experience
        the full service. No credit card required!
      </p>
      <nuxt-link to="/pricing" class="btn btn-primary rounded-xl mt-2"
    ...
    <div class="col-lg-7 offset-lg-1 pricing-wrapper">
      ...
      >
        ...
        <p class="mb-0 ps-3">
          Yearly <span class="text-fuchsia">(Save 30%)</span>
        </p>
      </div>
      <div class="row gy-6 position-relative mt-5">
        <div
          class="position-absolute pe-none d-none d-md-block"
          style="
            top: 55%;
            left: 50%;
            width: 140%;
        ...
        >
          <div class="pricing card">
            <div class="card-body pb-12">
              ...
              <!--/.prices -->
              <h4 class="card-title mt-2">{{ elm.category }} Plan</h4>
